...
const Hero = () => {
  return (
    ...
    >
          ...
          <div className="w-full px-4">
            ...
            >
              <div className="fixed inset-0 z-[-1]">
                {/* <Image
                    src={krawangan1} // Ganti dengan path gambar Anda
                    alt="Cover Image"
                    layout="fill"
                    objectFit="cover"
              ...
              <h1 className="mb-5 text-4xl font-bold leading-tight text-white sm:text-5xl sm:leading-tight md:text-6xl md:leading-tight z-10 relative">
                CV. Cipta <span className="text-blue-500">Mandiri</span> Perkasa
              </h1>
            </div>
          </div>
        </div>
      ...
      <div className="absolute right-0 top-0 z-[999] opacity-30 lg:opacity-100">
        <svg
          width="450"
          height="556"
          viewBox="0 0 450 556"
      ...
      <div className="absolute bottom-0 left-0 z-[999] opacity-30 lg:opacity-100">
        <svg
          width="364"
          height="201"
          viewBox="0 0 364 201"
