...
import logo from "@/public/images/cmp-logo.png";
        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  Jl. Raya Tambelang Kp. Pisang Batu Desa Kertamukti Kec.
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  {MenuData.map((menuItem, index) => (
                    <li key={index}>
                      <Link
                        href={menuItem.path} // Assuming each menuItem has a 'path' property
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              &copy; {new Date().getFullYear()} CV. Cipta Mandiri Perkasa
            </p>
          </div>
        </div>
