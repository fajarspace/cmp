const featuresData = [
  {
    ...
    title: "Lebih Indah",
    paragraph:
      "Gaya moderen dan klasik bisa kami buat sesuai pesanan sehingga membuat bangunan terlihat lebih indah",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Ringan",
    paragraph: "Bobot yang lebih ringan dibanding beton konvensional",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Tahan Lama",
    paragraph:
      "Daya tahan yang baik terhadap kerusakan akibat faktor cuaca, korosi, api, pengikisan, jamur dan perubahan suhu",
  },
  {
    id: 1,
    icon: (
  ...
  },
  {
    ...
    title: "Customize",
    paragraph:
      "Warna dan bentuk dapat disesuaikan dengan keinginan customer (pengerjaan flexible)",
  },
];
